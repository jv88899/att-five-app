...
const PlayerCard = props => (
    <div className="player__card">
        <img
            className="player__img img-responsive"
        ...
        <div className="player__card__stats">
            <div className="player__card__stats__points">
                <p>Points:</p>
                <p>{props.pointsPerGame}</p>
            </div>
            <div className="player__card__stats__rebounds">
                <p>Rebounds:</p>
                <p>{props.reboundsPerGame}</p>
            </div>
            <div className="player__card__stats__assists">
                <p>Assists:</p>
                <p>{props.assistsPerGame}</p>
            </div>
            <div className="player__card__stats__blocks">
                <p>Blocks:</p>
                <p>{props.blocksPerGame}</p>
            </div>
            <div className="player__card__stats__steals">
                <p>Steals:</p>
